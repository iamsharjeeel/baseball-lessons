  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="mt-12 rounded-md border border-dashed border-chalk-white/30 bg-paper-white/5 p-10 text-center lg:mt-16"
      >
        <p className="font-body text-base font-semibold uppercase tracking-widest text-clay-red">
          Testimonials pending
        </p>
        <p className="mx-auto mt-3 max-w-md text-base leading-relaxed text-chalk-white/70">
          2–3 real parent testimonials go here once received. Per{' '}
          <code className="text-chalk-white/90">CONTENT_SPEC.md</code>, this
